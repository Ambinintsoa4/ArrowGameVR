using Assets._BowAndArrow.Scripts.Extra;
using System;
using UnityEngine;
...
public class PullMeasurer : XRBaseInteractable
{
    ...
    protected override void OnSelectEntered(SelectEnterEventArgs args)
    {
        ...
        captor = new Captor();
        captor.Released += RealeasedTrigger;
        captor.RunWithEvent();

    }

    private void RealeasedTrigger(object sender, ReleaseadEventArgs e)
    {
        x = e.Value;
        // force unselect
    }
